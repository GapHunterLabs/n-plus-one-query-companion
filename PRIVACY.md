...
**None.** N+1 Query Companion makes zero network calls during normal
operation. Every warning shown is computed directly from source already
present on your local disk — no external service, no telemetry
endpoint, ever.

## Third parties

None. N+1 Query Companion has no third-party SDKs, no analytics
