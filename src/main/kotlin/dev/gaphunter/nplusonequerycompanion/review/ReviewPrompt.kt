package dev.gaphunter.nplusonequerycompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.nplusonequerycompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.nplusonequerycompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "N+1 Query Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33888-n-1-query-companion/reviews"
